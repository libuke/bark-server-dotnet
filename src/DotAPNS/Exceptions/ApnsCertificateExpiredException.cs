...
public class ApnsCertificateExpiredException : Exception
{
    ...
    public ApnsCertificateExpiredException(string message = ConstMessage, Exception? innerException = null) : base(message, innerException) { }
}
